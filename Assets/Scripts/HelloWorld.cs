...
public class HelloWorld : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else
        {
            ...
            //message = "Ask steve anything..";
#endif
            config = SpeechConfig.FromSubscription("26ff6e7a35534f379f085cd72fa7cea7", "eastus2");
    ...
    void FixedUpdate()
    {
        ...
        {
            //recoButton.GetComponentInChildren<TMP_Text>().text = "Start";
            Debug.Log("Loop");
        }
    }
}
